...
var editUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, fullName, email, profile_picture, userId, user, response, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, fullName = _a.fullName, email = _a.email, profile_picture = _a.profile_picture;
                userId = req.userId;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db_1.db.user.update({
                        where: { id: userId },
                        data: {
                            fullName: (fullName === null || fullName === void 0 ? void 0 : fullName.trim()) || undefined,
            ...
            case 3:
                ...
                res.status(500).json({ message: "Failed to update user", error: err_2 });
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
